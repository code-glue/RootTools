...
/**
 * File information returned by fstat, lstat, and stat.
 * Corresponds to C's {@code struct stat} from {@code &lt;stat.h&gt;}.
 *
 * Functionally equivalent to https://android.googlesource.com/platform/libcore/+/master/luni/src/main/java/android/system/StructStat.java
 *
 */
final class StructStat
{
